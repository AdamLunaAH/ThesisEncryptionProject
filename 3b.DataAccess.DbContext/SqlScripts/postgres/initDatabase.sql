...
-- Grant permissions for Orleans clustering tables (created separately in orleans-clustering-init.sql)
-- These grants ensure gstusr role can access Orleans clustering infrastructure
...
-- Grant function permissions for Orleans functions
GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA gstusr TO gstusrrole;
...
GRANT ALL PRIVILEGES ON DATABASE "sql-encryption" TO dborole;
